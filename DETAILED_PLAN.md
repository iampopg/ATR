...
- **Must Achieve This Week:**
  ...
  - [ ] Create HKDF token generation function
  - [ ] Build HMAC proof validation system
  - [ ] Write CLI script that generates and validates tokens
  - [ ] Test token system with 10 different scenarios
  - [ ] Document token format and validation process
...
- **Must Achieve This Week:**
  - [ ] Implement ReadDirectoryChangesW monitoring for one folder
  - [ ] Create SQLite database schema for file tracking
  - [ ] Build file hash calculation function (SHA256)
  - [ ] Implement entropy calculation for files
  - [ ] Test monitoring by creating/modifying 20 test files
  - [ ] Log all file changes to database with timestamps
...
- **Must Achieve This Week:**
  - [ ] Connect token validation to file monitoring
  - [ ] Block write operations without valid tokens
  - [ ] Implement basic ransomware detection (>5 files in 10 seconds)
  - [ ] Create test script that simulates ransomware behavior
  - [ ] Successfully block simulated attack 8/10 times
